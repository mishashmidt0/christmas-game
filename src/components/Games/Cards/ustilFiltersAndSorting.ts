import {dataType, keyDataType} from "../../../store/cardsSlice";
...
export const allFilters = (card: dataType, filterValue: filterType, filter: filterRangeAndSortType): boolean => {
    if (
...
const filterValues = (card: dataType, key: keyType, filterValue: filterType): boolean => {
...
// Проверяем диапазон
const filterRange = (card: dataType, key: keyRangeType, filter: filterRangeAndSortType) => {
...
export const sort = (filteredArr: dataType[], sortKey: string) => {
